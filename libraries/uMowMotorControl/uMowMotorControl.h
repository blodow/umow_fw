#ifndef DualVNH5019MotorBoard_h
#define DualVNH5019MotorBoard_h

#include <Arduino.h>

#include "uMowPWMTimers.h"

class uMowMotorControl
{
  public:  
    // CONSTRUCTORS
    uMowMotorControl(); // Default pin selection.
    //uMowMotorControl(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
  ...
  private:
    unsigned char _INA1;
    unsigned char _INB1;
    uMowPWMTimers pwmTimers;
    //static const unsigned char _PWM1 = 10;
